*This is a modified project project from the previously existing ones. This project aims to compress files using the Huffman Compression Algorithm, where the code is built in C programming language.
